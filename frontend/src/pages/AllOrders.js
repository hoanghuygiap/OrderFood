...
const AllOrders = () => {
    ...
    useEffect(() => {
        ...
        fetch("http://127.0.0.1:8000/api/all-orders/")
            ...
            .catch(err => console.error("Lỗi fetch:", err)); // Thêm catch lỗi cho an toàn
    }, [adminUser, navigate]); // Thêm dependencies để tránh cảnh báo vàng
        ...
        <AdminLayout>
            <div>
                <h3 className="text-center text-primary mb-4">
                    <i className="fas fa-list-alt me-1"></i>Detail of All Orders
                </h3>
                    ...
                    <tbody>
                        {orders.map((order, index) => (
                            <tr key={order.id}>
                                ...
                                <td>
                                    {/* Link đã hoạt động vì đã import ở trên */}
