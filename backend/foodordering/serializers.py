...
class UserSerializer(serializers.ModelSerializer):
    class Meta:
        model = User
        fields = ['id','first_name','last_name','email','mobile','reg_data'] 

# not order confirm cua addmin
class OrderSumarySerializer(serializers.ModelSerializer):
    class Meta:
        model = OrderAddress
...
class OrderDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = OrderAddress
        fields = ['order_number','order_time','order_final_status',
                  'address','user_first_name','user_last_name',
